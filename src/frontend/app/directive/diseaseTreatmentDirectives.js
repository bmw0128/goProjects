app.directive('patientgroupSearchTypeahead', function(){
        ...
        link: function(scope, elem, attr){
            ...
            scope.da= function(txt){
                ...
                if(scope.selectedPatientGroups != null){
                    for(var i=0; i < scope.selectedPatientGroups.length; i++)
                        patientGroupsInUse.push(scope.selectedPatientGroups[i].patientGroupName);
                }
